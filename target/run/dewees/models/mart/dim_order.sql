            ...
            using "dim_order__dbt_tmp121809800437"
            where (
                
                    "dim_order__dbt_tmp121809800437".order_id = "orders"."mart"."dim_order".order_id
                    and 
                
                    "dim_order__dbt_tmp121809800437".product_id = "orders"."mart"."dim_order".product_id
    ...
    (
        ...
        from "dim_order__dbt_tmp121809800437"
    )
